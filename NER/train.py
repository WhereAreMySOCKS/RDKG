...
def main():
    ...
    print(60 * "=", )
    print("当前使用模型为 {},是否使用 Bilstm {}，使用设备为 {}".format(bert_path_or_name,is_bilstm,device))
    ...
    model = BertModel(device).to(device)
    ...
    epoch_time, epoch_loss, f1_score = validate(model, dev_loader,device)
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        if f1_score < best_score:
            ...
            print('save model into '+target_file)
            best_score = f1_score
            patience_counter = 0
